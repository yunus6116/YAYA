...
List<SliderModel> getSlides() {
  ...
  //1
  sliderModel.setDesc(
      '2000 yılından bu yana UNDP, "herkes için eğitim" amacıyla çalışmalar yapıyor.');
  ...
  //2
  sliderModel.setDesc(
      'Maddi sıkıntılar ve bunun gibi sebepler yüzünden çocuklar okuldan alınıyor ve çalıştırılıyor.');
  ...
  //3
  sliderModel.setDesc(
      'Bizler de sizlerin desteği ile birlikte bunları çözmeyi hedefliyoruz.');
